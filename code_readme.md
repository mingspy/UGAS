...
| ability-system                     | 能力系统                                                                                                                                                    |                                                                                                                                                                                                      |
|                                    | [**AbilitySystemCharacter**](Packages/com.sjai013.abilitysystem/Runtime/ability-system/Components/AbilitySystemCharacter.cs)                            | **入口，看懂这个即可** <br/>  ability系统的调度，继承自MonoBehaviour,在Update中实现游戏效果的驱动：<br /> • 先清掉所有AttributeModifiers <br /> • 更新效果,即根据游戏效果更新其AttributeModifiers <br/> • 步进游戏效果，更新游戏效果的剩余时间，执行周期效果<br/> • 删掉失效的游戏效果。 |
...
|  |[AbilityController](Assets/My%20Gameplay%20Ability%20System/Ability%20System/Abilities/AbilityController.cs)| Update中更新cd UI图片的冷却画面，实际的冷却cd由AbilitySystemCharacter驱动                                                                                                                                               |                                                                                                                                                |
|||                                                                                                                                                                                                      |